...
def get_args(rest_args):
    ...
    parser.add_argument('--num-train-tasks', type=int, default=20)
    parser.add_argument('--num-eval-tasks', type=int, default=10)
    parser.add_argument('--num-ood-eval-tasks', type=int, default=10)
    ...
    parser.add_argument('--cvae-z-dim', type=int, default=5, help='dimensionality of latent space')
    ...
    parser.add_argument('--layer-type', type=str, default='SupCL')
