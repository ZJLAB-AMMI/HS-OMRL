...
def get_args(rest_args):
    ...
    parser.add_argument('--env-name', default='PointRobotGoal-v0')   # dense data collection
    parser.add_argument('--seed', type=int, default=0)
    parser.add_argument('--policy', default='sac')
    parser.add_argument('--max-rollouts-per-task', default=1)
    ...
    parser.add_argument('--alpha-lr', default=3e-4)
    parser.add_argument('--gamma', default=0.99)
    parser.add_argument('--soft-target-tau', default=0.005)
    parser.add_argument('--num-iters', default=500)
    ...
    parser.add_argument('--dense-train-sparse-test', default=False)
    ...
    parser.add_argument('--on-circle-init-state', default=False)
