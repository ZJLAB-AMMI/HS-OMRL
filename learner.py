...
class Learner:
    ...
    def save_buffer(self):
        ...
        np.save(os.path.join(self.output_dir, 'trajectory_starts'), self.policy_storage.task_buffers[0]._trajectory_starts[:size])
        np.save(os.path.join(self.output_dir, 'policy_starts'), self.policy_storage.task_buffers[0]._policy_starts[:size])
