...
from losses.losses import SupConLoss, HMLCLoss
...
class OfflineContrastive(OfflineMetaLearner):
    ...
    ## NEW ADDED !!!!!!
    def sample_batches(self, batch_size, trainset = True):
        task_idex = np.random.randint(0, self.train_samples_dataset.shape[0], size=(batch_size))
